...
/**
 * Rating — star rating input/display. Supports controlled/uncontrolled value,
 * fractional precision (e.g. half stars), hover, read-only display, keyboard
 * navigation, and color variants. Used for tour reviews (Review.rating 1–5).
 */
...
function Rating({
  ...
  const stars = React.useMemo(() => {
    // precision must be in (0, 1]; otherwise render nothing.
